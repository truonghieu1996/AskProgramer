                ...
                <form action="{{ url('/asks/myasks/add') }}" method="post">
                    ...
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" id="title" name="title" value=""
...
@if($errors->has('title')) $('#myModal').modal('show');@endif @if($errors->has('content')) $('#myModal').modal('show'); @endif
@endsection