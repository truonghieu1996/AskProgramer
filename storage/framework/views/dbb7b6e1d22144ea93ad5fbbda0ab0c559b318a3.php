<?php $__env->startSection('content'); ?>
	<div class="row">
		<div class="col">
			<div class="card">
				<div class="card-header">Information your profile</div>
				<div class="card-body">
					<table class="table table-bordered table-hover table-sm table-responsive">
						...
						<tbody>
							<tr>
								...
								<td class="text-center"><a href="#sua" data-toggle="modal" data-target="#myModalEdit" onclick="getUpdate(<?php echo e($user->id); ?>, '<?php echo e($user->name); ?>'); return false;" class="btn btn-warning btn-sm" style="width:40px;">edit</a></td>
							</tr>
						</tbody>
					</table>
				</div>
