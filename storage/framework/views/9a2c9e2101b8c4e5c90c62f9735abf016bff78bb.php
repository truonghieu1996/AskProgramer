...
<?php $__env->startSection('content'); ?> 
        ...
        <div class="form-group">
            <div class="form-group">
                ...
                <input type="text" class="form-control<?php echo e($errors->has('title') ? ' is-invalid' : ''); ?>" id="title" name="title"
                    value="" placeholder="" required /> <?php if($errors->has('title')): ?>
            ...
            <div class="form-group">
                ...
                <textarea class="ckeditor form-control<?php echo e($errors->has('content') ? ' is-invalid' : ''); ?>" id="content" name="content"
    ...
    <?php if($errors->has('title')): ?> $('#myModal').modal('show');<?php endif; ?> 
